...
\keywords{ultrametriski automāti, $p$-adiski skaitļi, vairākgalviņu automāti, valodu klases, galviņu hierarhija}
\end{abstract-lv}
\clearpage
...
\keywords{ultrametric automata, $p$-adic numbers, multi-head automata, language classes, head hierarchy}
\end{abstract-en}
