...
$$
	\begin{cases}
		...
		\cdots \\
		p^{a_1}\cdot p^{a_2 \cdot (2\cdot k)}\cdots p^{a_n \cdot (n\cdot k)} \cdot \frac{1}{p^{a_{n+1} \cdot (n\cdot k)}}\cdots \frac{1}{p^{a_{2n-1} \cdot (2\cdot k)}}\cdot \frac{1}{p^{a_{2n}}} = 1\\
	\end{cases}
$$,
pārrakstot
$$
	\begin{cases}
		...
		\cdots \\
		p^{a_1}\cdot p^{a_2 \cdot (2\cdot k)} \cdots p^{a_n \cdot (n\cdot k)} = p^{a_{n+1} \cdot (n\cdot k)}\cdots p^{a_{2n-1} \cdot (2\cdot k)}\cdot p^{a_{2n}}\\
	\end{cases}
$$
\end{pieradijums}
